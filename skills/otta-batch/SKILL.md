---
name: otta-batch
description: Use when running the Otta pipeline across many issues concurrently (one PR each).
---
...
Read and follow the [canonical batch workflow](../../commands/batch.md). Treat that command document as the source of truth; do not recreate its workflow here.
