#!/usr/bin/env python3
# otta-learning-policy.py — resolve per-run LEARN controls, prepare governed
# repo learnings, and route verdict capture through the resolved policy.
#
# Invoked through the otta-learning-policy.sh wrapper, which passes this
# script's own directory as argv[1] and forwards the caller's arguments after
# it. Eleven call sites in agents/, commands/, workflows/ and scripts/ still
# name the .sh entrypoint, so that wrapper is the stable public interface.
